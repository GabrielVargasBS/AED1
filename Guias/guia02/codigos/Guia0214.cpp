...
class MyRobot : public Robot
{
    ...
    void moveN ( int steps )
    {
     ...
     /**
      markBeepers - Metodo para guardar a coordenada
      dos marcadores tarefa em um arquivo.
      @param fileName - nome do arquivo
      */
     void markBeepers ( const char *fileName )
     {
         // definir dados
            int action;
            int x;
         ...
         // repetir enquanto acao maior ou igual a zero
            while (action > 0)
            {
                // testar se ha' marcadores proximos
                   if ( action != 7 )
                   {
                        // executar comando
                           execute (action);
                    ...
                    { 
                       ...
                       // guardar a coordenada em arquivo
                          archive << x << std::endl;
                          archive << y << "\n\n";
...
int main()
{
    ...
    // executar tarefa e gravar acoes
       robot->markBeepers       ("Tarefa0214b.txt");
    ...
    // retomar a entrada de comandos
       robot->appendActions     ("Tarefa0214.txt");
    
    // reproduzir todos os comandos
       robot->playActions       ("Tarefa0214.txt");

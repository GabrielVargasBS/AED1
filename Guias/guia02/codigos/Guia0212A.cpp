...
class MyRobot : public Robot
{
    ...
    chars dictionary(int action)
    {
     ...
     /**
      leftMove - Procedimento para virar 'a esquerda e mover-se
     */
    void leftMove()
     // testar se podera' virar e mover-se
     // para a esquerda
        if (leftIsClear())
        {
            turnLeft();
    ...
    /**
      rightMove - Procedimento para virar 'a direita e mover-se
     */
    void rightMove()
     // testar se podera' virar e mover-se
     // para a direita
...
int main()
{
    ...
    // executar tarefa e gravar acoes
       ...
       robot->recordActions     ("Tarefa0212.txt");
       robot->playActions       ("Tarefa0212.txt");
       robot->recordActions     ("Tarefa0212.txt");
       robot->translateActions  ("Tarefa0212.txt");
       robot->recordActions     ("Tarefa0212.txt");
    ...
    // retomar a entrada de comandos
       robot->appendActions     ("Tarefa0212.txt");

...
Valores: -20, -10, 1 , 10, 20, 30, 60, 70, 80, 0* 
(*nao sera considerado)

Valores dentro: 1
Valores fora  : 8 -- acima : 60, 70, 80          -- 37.50%
                |
                ---- abaixo: -20, -10, 1, 10, 20 -- 62.50%


Ha' 1 valor dentro do intervalo ]20.000000 ; 60.000000[

Dos 8 valores fora do intervalo:
~ 37.50 % sao maiores que 60.000000
~ 62.50 % sao menores que 20.000000
...
Valores: -20, -10, 1 , 10, 20, 30, 55, 60, 65, 70, 80, 90, 0*  
(*nao sera considerado)

Valores dentro: 3
Valores fora  : 9 -- acima : 70, 80, 90               -- 33.33%
                |
                ---- abaixo: -20, -10, 1 , 10, 20, 30 -- 66.67%


Ha' 3 valores dentro do intervalo ]50.000000 ; 70.000000[

Dos 9 valores fora do intervalo:
~ 33.33 % sao maiores que 60.000000
~ 66.67 % sao menores que 50.000000
...
Valores: 1 , 10, 20, 30, 55, 60, 65, 70, 0*  
(*nao sera considerado)

Valores dentro: 8
Valores fora  : 0

Ha' 8 valores dentro do intervalo ]-10.000000 ; 80.000000[
Ha' 0 valores fora   do intervalo ]-10.000000 ; 80.000000[
...
Valores: 35, 40, 45, 50, 0*  
(*nao sera considerado)

Valores dentro: 0
Valores fora  : 4

Ha' 0 valores dentro do intervalo ]20.000000 ; 30.000000[

Dos 4 valores fora do intervalo:
~ 100.00 % sao maiores que 30.000000
~ 0.00 % sao menores que 20.000000
...
Dos 4 valores fora do intervalo:
~ 0.00 % sao maiores que 30.000000
~ 100.00 % sao menores que 20.000000

...
// -------------------------------------------------------- definicoes operator
           ...
           bool operator!= ( Matrix <T> const other )
           {
               bool result = false;
               int  x      = 0;
               int  y      = 0;
...
// --------------------------------------------------------- definicoes funcoes
        ...
        /**
         * tridiagonalCrescente - substituir triagonal por valores crescentes
                                  e restante por zero
         * @param n             - nova dimensao da matriz ( para ajustar )
                                  * deve ser maior que 1
         * @return Matrix&      - matriz ajustada
         */

        Matrix& tridiagonalCrescente ( int n )
        {    
            if ( rows    <= 0 ||  columns <= 0 )
            {
                cout << "\nERROR: Missing data.\n" << endl;
            ...
            return ( *this );
        } // end tridiagonalCrescente ( )

        /**
         * tridiagonalDecrescente - substituir triagonal por valores
                                    decrescentes e restante por zero
         * @param n               - nova dimensao da matriz ( para ajustar )
                                    * deve ser maior que 1
         * @return Matrix&        - matriz ajustada
         */

        Matrix& tridiagonalDecrescente ( int n )
        {    
            if ( rows    <= 0 ||  columns <= 0 )
            {
                cout << "\nERROR: Missing data.\n" << endl;
        ...
        /**
         * potenciaPorLinha - Funcao para determinar se 
                              matriz segue esse padrao
         * @return true se seguir; false, caso contrario
         */
        bool potenciaPorLinha ( )
        {
            bool   result = false;
            int    x      = 0;
            int    y      = 0;
            ...
            return ( result );
        } // end potenciaPorLinha ( )

        /**
         * potenciaPorColuna - Funcao para determinar se 
                               matriz segue esse padrao
         * @return true se seguir; false, caso contrario
         */
        bool potenciaPorColuna ( )
        {
            bool   result = false;
            int    x      = 0;
            int    y      = 0;
